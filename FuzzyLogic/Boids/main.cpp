...
int main()
{
	...
	sf::RenderWindow window(sf::VideoMode(1280, 720, desktop.bitsPerPixel), "Boids", sf::Style::None); 
	...
	for (int i = 0; i < 100; i++) //Number of boids is hardcoded for testing pusposes.
	{
		...
		sf::CircleShape shape(8,10); //Shape with a radius of 10 and 3 points (Making it a triangle)
